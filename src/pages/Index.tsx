...
const ideas: Idea[] = [
  ...
  },
  {
    ...
    description: 'AI создает уникальные логотипы и брендбуки для стартапов',
    category: 'Творчество',
    complexity: 1,
    investment: 'До 100$',
    icon: 'Shapes',
    gradient: 'from-yellow-500 to-orange-500',
    howItWorks: 'Пользователь описывает бизнес, AI генерирует 10+ вариантов логотипов в разных стилях',
    monetization: ['10 логотипов: $9.99', 'Векторные файлы: $19.99', 'Полный брендбук: $49.99'],
    technologies: ['DALL-E 3', 'SVG генератор', 'Color palette AI'],
    launchPlan: ['День 1-4: Генератор логотипов', 'День 5-7: Экспорт файлов', 'День 8-10: Запуск']
  },
  {
    id: 12,
    title: 'Голосовой Клонер',
    description: 'Создание AI-голоса для озвучки контента и аудиокниг',
    category: 'AI-генеративные',
    complexity: 3,
    investment: '500$+',
    icon: 'Mic',
    gradient: 'from-red-500 to-pink-500',
    howItWorks: 'AI клонирует голос по 5-минутной записи для создания неограниченного аудио контента',
    monetization: ['1 голос: $29.99', '5 голосов: $99.99', 'Commercial: $299/мес'],
    technologies: ['ElevenLabs API', 'Voice cloning', 'Audio processing'],
    launchPlan: ['День 1-10: Voice API интеграция', 'День 11-15: Тестирование', 'День 16-20: Запуск']
  },
  {
    id: 13,
    title: 'Контракт Генератор',
    description: 'AI создает юридические документы и договоры за минуты',
    category: 'Бизнес',
    complexity: 2,
    investment: '100-500$',
    icon: 'FileCheck',
    gradient: 'from-blue-500 to-indigo-500',
    howItWorks: 'AI анализирует требования и генерирует юридически корректные контракты с кастомизацией',
    monetization: ['1 контракт: $12.99', '10 контрактов: $79.99', 'Unlimited: $149/мес'],
    technologies: ['GPT-4 fine-tuned', 'Legal database', 'PDF генератор'],
    launchPlan: ['День 1-7: Юридические шаблоны', 'День 8-12: AI интеграция', 'День 13-15: Запуск']
  },
  {
    id: 14,
    title: 'Мем Фабрика',
    description: 'AI генерирует вирусные мемы для соцсетей и маркетинга',
    category: 'Развлечения',
    complexity: 1,
    investment: 'До 100$',
    icon: 'Smile',
    gradient: 'from-green-500 to-emerald-500',
    howItWorks: 'AI создает актуальные мемы на основе трендов, с автоматическим подбором шаблонов',
    monetization: ['20 мемов: $4.99', '100 мемов: $14.99', 'Unlimited: $29/мес'],
    technologies: ['Meme templates API', 'Trending analysis', 'Image generation'],
    launchPlan: ['День 1-3: Библиотека шаблонов', 'День 4-6: AI генерация', 'День 7-10: Запуск']
  },
  {
    id: 15,
    title: 'Презентация за 10 минут',
    description: 'AI создает профессиональные презентации из текста',
    category: 'Бизнес',
    complexity: 2,
    investment: 'До 100$',
    icon: 'Presentation',
    gradient: 'from-purple-500 to-blue-500',
    howItWorks: 'AI превращает текстовое описание в дизайнерскую презентацию с графиками и визуалами',
    monetization: ['1 презентация: $7.99', '5 презентаций: $29.99', 'Pro: $59/мес'],
    technologies: ['GPT-4 структура', 'Design templates', 'Chart generation'],
    launchPlan: ['День 1-5: Шаблоны дизайна', 'День 6-8: AI интеграция', 'День 9-12: Запуск']
  },
  {
    id: 16,
    title: 'SEO Статьи Автор',
    description: 'AI пишет SEO-оптимизированные статьи для блогов',
    category: 'Бизнес',
    complexity: 2,
    investment: '100-500$',
    icon: 'FileText',
    gradient: 'from-teal-500 to-cyan-500',
    howItWorks: 'AI создает уникальные статьи с ключевыми словами, мета-тегами и структурой для SEO',
    monetization: ['1 статья: $9.99', '10 статей: $69.99', 'Agency: $199/мес'],
    technologies: ['GPT-4 writing', 'SEO analyzer', 'Keyword research'],
    launchPlan: ['День 1-5: SEO алгоритмы', 'День 6-10: Генерация контента', 'День 11-14: Запуск']
  },
  {
    id: 17,
    title: 'AI-Переводчик Pro',
    description: 'Контекстный перевод документов с сохранением смысла',
    category: 'AI-генеративные',
    complexity: 2,
    investment: 'До 100$',
    icon: 'Languages',
    gradient: 'from-orange-500 to-yellow-500',
    howItWorks: 'AI переводит с учетом контекста, терминологии и культурных особенностей',
    monetization: ['5000 слов: $4.99', '50000 слов: $29.99', 'Unlimited: $79/мес'],
    technologies: ['GPT-4 translation', '100+ языков', 'Context analysis'],
    launchPlan: ['День 1-4: Multi-language setup', 'День 5-7: Context engine', 'День 8-10: Запуск']
  },
  {
    id: 18,
    title: 'Рецепты от AI Шефа',
    description: 'Персонализированные рецепты по ингредиентам из холодильника',
    category: 'Развлечения',
    complexity: 1,
    investment: 'До 100$',
    icon: 'ChefHat',
    gradient: 'from-red-500 to-orange-500',
    howItWorks: 'AI создает рецепты из имеющихся продуктов с учетом диеты и предпочтений',
    monetization: ['50 рецептов: $3.99', 'Premium: $9.99/мес', 'Family: $19.99/мес'],
    technologies: ['Recipe database', 'Nutrition API', 'Image generation'],
    launchPlan: ['День 1-5: База рецептов', 'День 6-8: AI генерация', 'День 9-10: Запуск']
  },
  {
    id: 19,
    title: 'Workout План AI',
    description: 'Персональные тренировки на основе целей и физической формы',
    category: 'Бизнес',
    complexity: 2,
    investment: '100-500$',
    icon: 'Dumbbell',
    gradient: 'from-green-500 to-teal-500',
    howItWorks: 'AI создает индивидуальный план тренировок с видео и отслеживанием прогресса',
    monetization: ['1 месяц: $14.99', '3 месяца: $34.99', 'Годовой: $99.99'],
    technologies: ['Exercise database', 'Progress tracking', 'Video library'],
    launchPlan: ['День 1-7: База упражнений', 'День 8-12: AI планирование', 'День 13-16: Запуск']
  },
  {
    id: 20,
    title: 'Тест-Кейсы Генератор',
    description: 'AI создает тестовые сценарии для QA и разработчиков',
    category: 'Бизнес',
    complexity: 2,
    investment: '100-500$',
    icon: 'Bug',
    gradient: 'from-purple-500 to-pink-500',
    howItWorks: 'AI анализирует требования и генерирует полный набор test cases',
    monetization: ['10 test suites: $19.99', '50 suites: $79.99', 'Enterprise: $299/мес'],
    technologies: ['GPT-4 analysis', 'Test frameworks', 'Export formats'],
    launchPlan: ['День 1-6: Test patterns', 'День 7-10: AI генерация', 'День 11-14: Запуск']
  }
];
